      ...
      <div class="row justify-content-center">
        <div class="col-12 col-md-4 col-lg-4">
          <div style="padding-top: 20px; padding-bottom: 10px">
            <h6 style="padding-top: 5px;" class="text-primary">86% Complete</h6>
            <div class="progress" >
<div class="progress-bar progress-bar-striped" role="progressbar" style="width: 86%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12 col-md-12 col-lg-12 text-center"  style="padding-top:25px; padding-bottom:10px">
          <h3><b>Are dental or vision plans important to you?</b></h3>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12 col-md-4 col-lg-4 text-center">
          <button type="button" id="button1" class="button-19"><b>Yes</b></button>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12 col-md-4 col-lg-4 text-center"  style="padding-top:20px">
          <button type="button" id="button2" class="button-19"><b>No</b></button>
        </div>
      </div>
    </div>
...
function handleButtonClick(text) {
  localStorage.setItem("Are dental or vision plans important to you?", text);
...
class question6Component extends HTMLElement {
  constructor() {
    super();
